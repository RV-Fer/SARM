...
public class SolicitudTemporal {
    ...
    public static SolicitudTemporal crearSolicitud(int duracionDias, String motivo, String fechaFin) {
        return new SolicitudTemporal(duracionDias, motivo, fechaFin);
    }

    // Consultar Solicitud Temporal (leer)
